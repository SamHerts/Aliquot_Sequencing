...
pub fn main() {
    ...
    perform_bench::<Sieve<algorithm::Tile, FlagData<flag_data::Stripe, [u8; STRIPE_SIZE]>, [u8; STRIPE_SIZE]>, algorithm::Tile>(algorithm::Tile(arguments.set_size * 1024), arguments.sieve_size, arguments.duration);
}
...
struct Arguments {
    ...
    #[structopt(short, long, default_value = "100000000")]
    sieve_size: usize,
